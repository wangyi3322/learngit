...
var Note = __webpack_require__(19).Note;
...
Note.prototype = {
  ...
  createNote: function () {
    var tpl =  '<div class="note">'
              ...
              + '<div class="note-ct paper" contenteditable="true"></div>'
              +'</div>'
    this.$note = $(tpl)
  ...
  bindEvent: function () {
    ...
    $noteCt.on('focus', function() {
      if($noteCt.html()=='请在这里输入') $noteCt.html('');
